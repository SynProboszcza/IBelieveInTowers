...
Game is still in developement, but there is a stable version. To run it, download the newest version from [Releases](https://github.com/SynProboszcza/IBelieveInTowers/releases) tab.<br>
Game features:<br>
