...
public class PreMainGame : MonoBehaviourPunCallbacks
{
    ...
    void Update()
    {
        ...
        if (PhotonNetwork.IsConnectedAndReady)
        {
            ...
            RefreshTextfields(PhotonNetwork.CurrentLobby.Type.ToString(), PhotonNetwork.CurrentRoom.Name.ToString(), PhotonNetwork.CloudRegion, PhotonNetwork.NickName, "XxX_Crusher_XxX");
        }
    }
